...
export class PokeDetailPage implements OnInit {
  ...
  constructor(private router: Router, private myToast : ToastController, private storage: Storage, private apiService : ApiService, private data : TransferDataService, private fav : FavoriteService, private tserv : TeamService) { 
